# =============================================================================
# Savvey: push V.52 + V.53 + V.54 + V.55 in sequence.
#   V.52 - KV cache prefix bump (instant flush of EUR-cached entries)
#   V.53 - layout fix (Type/Confirm/Welcome bottom nav clearance)
#   V.54 - result-screen honesty fixes + dedup copy
#   V.55 - empty verdict-block + Amazon CTA copy on low-conf
#
# RUN:
#   cd "C:\Users\vince\OneDrive\Desktop\files for live"
#   powershell -ExecutionPolicy Bypass -File PUSH-ALL-V52-V55.ps1
# =============================================================================
...
$scripts = @(
    ...
    'APPLY85-wave-v54.ps1',
    'APPLY86-wave-v55.ps1'
)
...
Write-Host "  V.52 + V.53 + V.54 + V.55 attempted" -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Green
