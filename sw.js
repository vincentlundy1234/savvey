...
const STATIC_VER    = 'savvey-static-v113';
...
const STATIC_ASSETS = ['/', '/index.html', '/manifest.json', '/components/loading-screen.js', '/components/result-banners.js', '/components/share-canvas.js'];
const FONT_ORIGINS  = [
